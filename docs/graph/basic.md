...
设 $D$ 为 $n (n \geq 1)$ 阶无向简单图，若 $G$ 中每个顶点均与其余的 $n-1$ 个顶点相邻，则称 $D$ 为 $n$ 阶无向完全图。
...
#### 判别法
 ...
 $a=(a_1, a_2, \cdots, a_n)$ 可简单图化当且仅当 $a'=(a_2 - 1, a_3 - 1, \cdots, a_{a_1+1} - 1, a_{a_1+2}, \cdots, a_n)$ 是可简单图化的。
